<?php
// source: C:\xampp\htdocs\coding_portfolio/config/common.neon
// source: C:\xampp\htdocs\coding_portfolio/config/services.neon
// source: array
...
class Container_39a34dc26e extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'ArrayAccess' => [2 => ['01', 'application.1', 'application.2', 'application.3', 'application.5', 'application.6']],
		'Nette\Application\Routers\RouteList' => [['01']],
		'Nette\Application\UI\Presenter' => [
			2 => ['application.1', 'application.2', 'application.3', 'application.5', 'application.6'],
		],
		...
		'App\UI\About\AboutPresenter' => [2 => ['application.1']],
		'App\UI\Contact\ContactPresenter' => [2 => ['application.2']],
		...
		'App\UI\Portfolio\PortfolioPresenter' => [2 => ['application.6']],
	...
	public function createServiceApplication__1(): App\UI\About\AboutPresenter
	{
		$service = new App\UI\About\AboutPresenter;
	...
	public function createServiceApplication__2(): App\UI\Contact\ContactPresenter
	{
		$service = new App\UI\Contact\ContactPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__6(): App\UI\Portfolio\PortfolioPresenter
	{
		$service = new App\UI\Portfolio\PortfolioPresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\coding_portfolio/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\coding_portfolio/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\coding_portfolio/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_39a34dc26e
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=portfolio', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_39a34dc26e $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\coding_portfolio/temp/cache/latte');
